...
void setup() {
    ...
    // Đặt độ phân giải thành 320x240 (QVGA) và chất lượng ảnh
    config.frame_size = FRAMESIZE_QVGA;  // 320x240
    config.jpeg_quality = 30;  // Chất lượng trung bình, tốc độ nhanh hơn
    config.fb_count = 1;  // Giảm số buffer để tiết kiệm RAM
